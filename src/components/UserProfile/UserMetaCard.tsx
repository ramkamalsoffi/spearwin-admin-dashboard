              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <Input
                      type="text"
                      value={user?.socialLinks?.facebook || "https://www.facebook.com/PimjoHQ"}
                    />
                  </div>

                  <div>
                    <Label>X.com</Label>
                    <Input type="text" value={user?.socialLinks?.twitter || "https://x.com/PimjoHQ"} />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value={user?.socialLinks?.linkedin || "https://www.linkedin.com/company/pimjo"}
                    />
                  </div>

                  <div>
                    <Label>Instagram</Label>
                    <Input type="text" value={user?.socialLinks?.instagram || "https://instagram.com/PimjoHQ"} />
                  </div>
                </div>
              </div>
              <div className="mt-7">
