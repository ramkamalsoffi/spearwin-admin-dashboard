            ...
            <Table className="w-full min-w-[700px]">
              <TableHeader>
                <TableRow className="bg-blue-50 mx-4">
                  ...
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-blue-900 uppercase tracking-wide">Native</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-blue-900 uppercase tracking-wide">ISO Code</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-blue-900 uppercase tracking-wide">Is RTL</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-blue-900 uppercase tracking-wide">Is Default</TableCell>
              ...
              <TableBody className="bg-white divide-y divide-gray-200">
                {languagesData.map((row) => (
                  <tr key={row.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{row.native}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{row.isoCode}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{row.isRTL ? "Yes" : "No"}</td>
