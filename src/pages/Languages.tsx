            ...
            <Table className="w-full min-w-[700px]">
              <TableHeader>
                <TableRow className="bg-muted/30 bg-gray-100 mx-4">
                  ...
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Native</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">ISO Code</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Is RTL</TableCell>
                  <TableCell isHeader className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Is Default</TableCell>
              ...
              <TableBody className="bg-white divide-y divide-gray-200">
                {languagesData.map((row) => (
                  <tr key={row.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-900">{row.native}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-900">{row.isoCode}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-900">{row.isRTL ? "Yes" : "No"}</td>
          ...
          <div className="px-6 py-3 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-700">
                Showing 1-{languagesPerPage} of {totalLanguages}
              </div>
              <div className="flex items-center gap-2">
                <button 
