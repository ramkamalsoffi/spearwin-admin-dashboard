              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {jobs.map((job) => (
                  <tr key={job.id} className="hover:bg-gray-50">
                    <td className="pl-6 pr-3 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{job.jobTitle}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{job.companyName}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{job.location}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-900">{job.jobType}</td>
                    <td className="px-3 py-3 whitespace-nowrap text-sm text-gray-500">{job.jobDescription}</td>
